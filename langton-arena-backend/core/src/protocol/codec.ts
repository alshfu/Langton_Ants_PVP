 ...
 */
export function encodeMessage<T extends WsMessage>(msg: T): Uint8Array {
 ...
 */
export function decodeMessage(buf: Uint8Array | ArrayBuffer): unknown {
  // TODO: msgpack decode
 ...
 */
export function isClientMessage(msg: unknown): msg is ClientToServer {
 ...
 */
export function isServerMessage(msg: unknown): msg is ServerToClient {
  if (!msg || typeof msg !== 'object') return false;
  const t = (msg as Record<string, unknown>).type;
