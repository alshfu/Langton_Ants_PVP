// services/ws-gateway/src/handlers/matchmaking.ts
//
// Обработка matchmaking:* сообщений.
// Подробнее: docs/backend-architecture.md §4.3.

import type { Client } from '../connection';

export async function handleMatchmaking(_client: Client, _msg: unknown): Promise<void> {
  // TODO:
