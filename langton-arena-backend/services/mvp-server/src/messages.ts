// src/messages.ts
//
// WebSocket protocol — типы сообщений между клиентом и сервером.
// Источник: docs/stage8-pvp-mvp-spec.md §4.2.
//
...
//
// Stage 8 Day 2: типы определены целиком (для Day 3-5 handlers), но
// handlers пока stub'ы.
