...
describe('Match — lifecycle', () => {
    ...
    it('broadcast match_tick на каждом тике', async () => {
        ...
        const tickMsgsA = a.sent.filter((s) => s.type === 'match_tick');
        const tickMsgsB = b.sent.filter((s) => s.type === 'match_tick');
    ...
    it('time win condition: tick >= threshold → match_ended', async () => {
        ...
        const ended = a.sent.find((s) => s.type === 'match_ended');
